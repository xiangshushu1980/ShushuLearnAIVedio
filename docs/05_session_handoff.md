...
4. **H3 参数探索**：steps 20→更少？分辨率 768 短边下限；length 124→更长时间（trained 范围 124-362）；ref_image_size match/max
5. **SageAttention 对 H3 效果**：start.sh 已带 --use-sage-attention，部分层 dtype 不符自动回退（日志有提示属正常）
