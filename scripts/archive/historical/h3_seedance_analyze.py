...
输出: experiments/archive/seedance_verify/analysis.json + compare_<case>.png（每 case 8 帧横条）
"""
import json
import os
import sys
...
ANALYZE = "/home/sean/projects/comfy-ops/experiments/archive/seedance_verify"
N_FRAMES = 8  # 拼图帧数
